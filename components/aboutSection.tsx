        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className={clsx(
              ...
              The official alumni association of St. Joseph of Nazareth High School, Kavule Katende, uniting 
              graduates from 2008 to present. We foster a vibrant community focused on networking, career 
              development, sportsmanship, and charitable outreach while maintaining ongoing member engagement.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className={clsx(
            ...
            <p className={clsx(
              ...
              To promote the best interests of the school and its alumni through active engagement and 
          ...
          <div className={clsx(
            ...
            <p className={clsx(
              ...
              To develop and maintain relationships with Alumni and the school as a whole, support and encourage 
              these groups in their endeavors and extend a hand of fellowship through financial, material support, 
              and communication while bringing value to the alumni body and supporting the school&rsquo;s goals.
            </p>
          </div>
        </div>
